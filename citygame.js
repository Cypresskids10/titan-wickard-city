...
function init() {
    ...
    camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 10000000000000000000000000000);
    ...
    const onKeyDown = function (event) {
        switch (event.code) {
            ...
            case 'ShiftLeft':
                ...
                break;
            case 'KeyC':
                if(isCrouching != true) camera.position.y -= 10;
                isCrouching = true;
                break;
        }
    }
    ...
    loader.load("./Gamertron111 city.glb", function(gltf){
        let city = gltf.scene
